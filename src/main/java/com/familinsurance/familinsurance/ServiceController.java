...
public class ServiceController {
    ...
    public @ResponseBody String send() {
        sendEmail("jonathanalexandergonzalezleon@gmail.com","Servicios de nuestra empresa","joketov640@tagbert.com","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");
        return "enviado";
    }
